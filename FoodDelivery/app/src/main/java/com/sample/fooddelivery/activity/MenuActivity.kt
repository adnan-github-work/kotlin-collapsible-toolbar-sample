...
import com.sample.fooddelivery.fragment.CartFragment
...
class MenuActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewPagerAdapter.addFragment(CartFragment(), "Orders")
        viewPagerAdapter.addFragment(CartFragment(), "Information")
